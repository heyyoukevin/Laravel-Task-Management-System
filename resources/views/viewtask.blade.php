...
<tr>
     ...
     <td> <a class="btn btn-primary" href="/edittask/{{$userf->prjid}}/{{$userf->mid}}/{{$userf->id}}">EDIT TASK</a></td>

     <td> <a class="btn btn-success" href="/reassigntask/{{$userf->prjid}}/{{$userf->mid}}/{{$userf->id}}">REASSIGN TASK</a></td>

    <form action="/deletetask/{{$userf->prjid}}/{{$userf->mid}}/{{$userf->id}}" method="POST">
     {{ csrf_field() }}
