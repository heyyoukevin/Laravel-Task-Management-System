      ...
      <div class="row">
         <div class="col-lg-12">
            <div class="full text_align_center heading_s1">
                 <h2 style="width: 100%;text-align: center;">REASSIGN TASK</h2>
            </div>
         </div>
      </div>		
</section>
...
<fieldset>
<center>
<form action="/reassigntask/againassigntask" method="POST" onSubmit="return check()">
{{ csrf_field() }}
<table>
...
<script type="text/javascript">
    ...
    if (mdasgn.value == "Select")
        {
            alert("Please reassign the task");
            return false;
        }
    else
        {
