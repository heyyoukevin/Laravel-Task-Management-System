      ...
      <div class="row">
         <div class="col-lg-12">
            <div class="full text_align_center heading_s1">
                 <h2 style="width: 100%;text-align: center;">EDIT MODULE DETAILS</h2>
            </div>
         </div>
      </div>		
</section>
...
<fieldset>
<center>
<form action="/editmodule/updatemodule" method="POST" onSubmit="return check()">
{{ csrf_field() }}
<table>
...
<td>MODULE TITLE</td>
<td><input type="text" name="mdtl" id="mdtl" value="{{$user->mdtl}}" required ></td>
